...
function Skill({ name, imageSrc }: { name: string; imageSrc: string }) {
  return (
    <BackgroundGradient className="custom-cursor-hidden">
      ...
      <div className="custom-cursor-hidden flex-center group relative aspect-square h-16 flex-col rounded-3xl bg-zinc-800 p-2 hover:opacity-90 max-sm:p-2 md:h-16 lg:h-24">
        <Image
          src={imageSrc}
          alt={name}
          width={200}
          ...
          className="custom-cursor-hidden aspect square rounded-2xl object-contain"
        />
