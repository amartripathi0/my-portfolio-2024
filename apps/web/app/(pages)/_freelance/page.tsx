  ...
  return (
    <PageLayout pageId="freelance-work" pageTitle="Freelance Work">
      ...
      <div className="relative">
        <p className="mb-4 text-center text-base font-semibold text-neutral-300">
        ...
        <Link
          href={'#contact-me'}
          scroll
          className="-z-5 absolute -top-24 right-6 rotate-6 rounded-full p-2 text-sm font-semibold text-neutral-200 md:rotate-6 md:px-2.5 md:text-base"
        >
          <BorderBeam size={60} duration={5} borderWidth={2} delay={4.6} />
          <span className="underline decoration-purple-400">HIRE ME</span> — and Get It Done!
        </Link>
      </div>
