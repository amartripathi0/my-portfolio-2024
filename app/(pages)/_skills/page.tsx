...
function Skills() {
  ...
  return (
    <motion.div
      id="skills"
      className="h-[calc(100vh-7rem)] pt-10 -mx-40 max-sm:pt-20 flex justify-around  flex-col gap-14 relative "
    >
      <motion.div
        initial={"initial"}
        whileInView={"inView"}
      ...
      {/* bg gradient purple */}
      <div
        className="absolute opacity-80 left-36 h-1/5 top-4 aspect-square  blur-[100px] rounded-full
      bg-gradient-to-r from-indigo-600 via-yellow-300 to-purple-400    
      "
      ></div>

      <div className="text-sm max-sm:text-sm max-sm:px-2 text-justify h-4/5 overflow-hidden  flex items-center justify-evenly flex-col relative">
