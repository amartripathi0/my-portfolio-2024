function IndigoBlurBackground({top , left , height , mobHeight ,right , minusTop , additionalStyles } : {top ?: string , left ?: string , height ?: string , mobHeight ?: string , right ?: string , minusTop ?: string , additionalStyles ?: string}) {
  return (
    < div
