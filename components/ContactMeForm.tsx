...
export function ContactMeForm() {
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input">
      <form action={(formData) => sendEmail(formData)}>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="name">Name</Label>
            <Input id="name" name="name" placeholder="Please enter your name here" type="text" required/>
          </LabelInputContainer>
        
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Email Address</Label>
          <Input id="email" name= "email" placeholder="Please enter your email here" type="email" required/>
        </LabelInputContainer>
